    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-purple-800 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-light text-white mb-3 tracking-wide">Focus Flow</h1>
          <p className="text-purple-200 text-lg font-light">Pomodoro • Binaural Beats • Deep Work</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Main Timer Display */}
            <div 
              className="rounded-2xl p-8 border border-white border-opacity-10"
              style={{
            ...
            >
              <div className="text-center">
                ...
                <div className="relative mb-8">
                  <div className="text-9xl font-extralight text-white mb-4 tracking-wider" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                    {formatTime(timeLeft)}
                  </div>
                ...
                <div className="flex justify-center gap-4 mb-8">
                  {!isRunning ? (
                    <button
                      onClick={startTimer}
                      className="group flex items-center gap-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 px-8 py-4 rounded-full font-medium transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 text-white"
                    >
                    ...
                    <button
                      onClick={pauseTimer}
                      className="group flex items-center gap-3 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 px-8 py-4 rounded-full font-medium transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 text-white"
                    >
                  ...
                  <button
                    onClick={resetTimer}
                    className="group flex items-center gap-3 px-8 py-4 rounded-full font-medium transition-all duration-200 border border-white border-opacity-20 hover:scale-105 text-white"
                    style={{
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {/* Audio Controls */}
              <div 
                className="rounded-2xl p-6 border border-white border-opacity-10"
                style={{
                  background: 'rgba(255, 255, 255, 0.03)',
                  backdropFilter: 'blur(16px)',
                  WebkitBackdropFilter: 'blur(16px)',
              ...
              >
                <h3 className="text-white font-medium mb-4 text-center">Audio Control</h3>
                <div className="flex justify-center gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-3 rounded-full font-medium transition-all duration-200 bg-blue-600 hover:bg-blue-700 text-white text-sm shadow-lg hover:scale-105"
                  >
                    Test 3s
                  </button>
                </div>
              ...
              >
                <h3 className="text-white font-medium mb-4 text-center">Progress</h3>
                <div className="text-center">
                  <div className="text-3xl font-light text-white mb-1">{sessions}</div>
                  <div className="text-purple-200 text-sm">Sessions Completed</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            >
              <h2 className="text-2xl font-light text-white mb-6 text-center">Today's Focus</h2>
              ...
              <div className="flex gap-3 mb-6">
                <input
                  ...
                  className="flex-1 rounded-xl px-4 py-3 placeholder-purple-200 focus:outline-none focus:ring-2 focus:ring-purple-400 border border-white border-opacity-10 text-white"
                  style={{
                    background: 'rgba(255, 255, 255, 0.08)',
                    backdropFilter: 'blur(8px)',
                    WebkitBackdropFilter: 'blur(8px)'
                ...
                <button
                  onClick={addTodo}
                  className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 p-3 rounded-xl transition-all duration-200 shadow-lg hover:scale-105"
                >
              ...
              {todos.length > 0 && (
                <div className="mb-6">
                  ...
                  >
                    <div
                      className="bg-gradient-to-r from-emerald-400 to-cyan-400 h-3 rounded-full transition-all duration-500 ease-out"
              ...
              {/* Todo List */}
              <div className="space-y-3 max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-purple-400 scrollbar-track-transparent">
                {todos.map(todo => (
                  <div
                    key={todo.id}
                    className={`group flex items-center gap-3 p-4 rounded-xl border border-white border-opacity-10 transition-all duration-200 ${
                ...
                {todos.length === 0 && (
                  <div className="text-center text-purple-200 py-12">
                    ...
                    <p className="text-sm text-purple-300">Add one above to get started</p>
                  </div>
                )}
              </div>
            </div>
        ...
        {/* Footer */}
        <div className="text-center mt-12 text-purple-200 text-sm font-light">
